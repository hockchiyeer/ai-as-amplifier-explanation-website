...
export function CaseStudyCard({ title, scenario, outcome, lesson, scenarioLabel = 'Scenario', outcomeLabel = 'Outcome', lessonLabel = 'Core Business Lesson', index }: CaseStudyCardProps) {
  return (
