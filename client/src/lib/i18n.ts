// Bilingual content configuration for the AI Amplifier website
...
export const i18n = {
  en: {
    ...
    hero: {
      ...
      description:
        "In the age of abundant computing resources, AI doesn't make you smarter. It amplifies what you already do—for better or worse. Learn how to harness AI as a strategic multiplier while avoiding the pitfalls that turn competitive advantages into compounded failures.",
    ...
    threeEffects: {
      ...
      amplifier: {
        ...
        icon: '⚡',
        description:
          'AI magnifies every action\'s impact—whether good or bad. A correct strategy produces outsized returns; a flawed strategy accelerates failure. AI doesn\'t create strategy; it exposes and amplifies what\'s already there.',
      ...
      multiplier: {
        ...
        icon: '✖',
        description:
          'AI multiplies your team\'s output and reach across channels, markets, and skill domains—operating where humans cannot. But when AI goes wrong, it also multiplies errors, misinformation, and poor decisions across the entire organization.',
      ...
      compounder: {
        ...
        icon: '📈',
        description:
          'AI advantages compound over time. Teams building AI systems today gain exponential competitive advantage over rivals still relying on linear human processes. But if built on flawed strategy, AI compounds errors just as relentlessly—pushing organizations toward increasingly costly, irreversible outcomes.',
    ...
    vibeCoding: {
      ...
      description:
        'Vibe Coding is the practice of using AI as a collaborative partner to amplify development velocity, code quality, and problem-solving capability. Rather than replacing developers, AI augments their judgment and accelerates their output.',
    ...
    strategicInsights: {
      ...
      question:
        'If your team completely stopped spending time on reactive tasks—responding to competitor announcements, generating routine reports, managing low-value communications—and redirected that freed capacity to AI-augmented strategic work, what investment opportunities would you pursue?',
      insight:
        'This question is often closer to the real source of competitive advantage than: "How do we respond to our competitor\'s latest product launch?"',
      keyPoint:
        'The real competitive advantage lies not in doing more, but in redirecting human capacity from reactive work to strategic thinking—amplified by AI.',
    },
    ...
    subtractPrinciple: {
      ...
      description:
        'When an AI trajectory becomes unproductive or misaligned, the solution is not to apply more compute or push harder. Instead, reset to a clean state, switch models, or inject fresh perspective.',
      ...
      takeaways: [
        {
          ...
          description:
            'AI doesn\'t determine outcome—your strategy does. Correct strategy gets amplified to produce outsized returns. Flawed strategy gets amplified to accelerate failure. Fix direction first.',
        },
        {
          icon: '✖',
          title: 'The Multiplier Works Both Ways',
          description:
            'Every AI deployment is a force multiplier. Mass-producing flawed messaging at scale is not strength—it is weakness at volume. Strategic clarity multiplied by AI is the only path to durable advantage.',
        },
        {
          icon: '📈',
          title: 'The Compounder Rewards Early Movers',
          description:
            'AI advantages compound via data, workflow, and speed moats. Teams building AI systems today create leads that late adopters cannot close—regardless of budget.',
        },
        {
          icon: '◆',
          title: 'Own the Strategy—Use AI to Accelerate',
          description:
            'Generate frameworks, retrieve knowledge, analyze data, and scale execution with AI. But always own the strategic logic, core assumptions, and quality bar yourself.',
        },
        {
          icon: '−',
          title: 'The Subtract Principle: Reset, Not Amplify',
          description:
            'When AI spirals—reset to clean state, switch models, inject fresh perspective. More compute on a flawed trajectory is brute-force in the wrong direction.',
        },
      ],
    },
    ...
    aiJourney: {
      ...
      steps: [
        { step: 1, title: 'Amplify', description: 'the right strategy' },
        { step: 2, title: 'Multiply', description: 'effective execution' },
        { step: 3, title: 'Compound', description: 'competitive advantages' },
      ],
  ...
  zh: {
    ...
    hero: {
      ...
      description:
        '在算力充裕的时代，AI 不会让你变得更聪明。它只会放大你已经在做的事——无论好坏。学习如何将 AI 作为战略倍增器，同时避免那些将竞争优势转化为复利失败的陷阱。',
      cta: '探索三大效应',
    },
    ...
    threeEffects: {
      ...
      amplifier: {
        ...
        icon: '⚡',
        description:
          'AI 放大每一个行动的影响——无论好坏。正确的战略会产生超额回报；有缺陷的战略则会加速失败。AI 不会创造战略；它只会暴露并放大你原本已有的战略。',
      ...
      multiplier: {
        ...
        icon: '✖',
        description:
          'AI 能倍增团队在各渠道、市场和职能领域的有效产出与覆盖范围——在人力无法兼顾之处同时运作。但当 AI 出错时，也会在整个组织中复制错误、错误信息和糟糕的决策。',
      ...
      compounder: {
        ...
        icon: '📈',
        description:
          'AI 带来的优势会随时间复利累积。今天构建 AI 系统的团队，将比仍依赖线性人工流程的竞争对手获得指数级领先优势。但若建立在有缺陷的战略之上，AI 同样会让错误随时间复利累积，把组织推向代价越来越高、越来越难以逆转的结局。',
    ...
    vibeCoding: {
      ...
      description:
        '敏捷编码是将 AI 作为协作伙伴来放大开发速度、代码质量和问题解决能力的实践。AI 不是替代开发者，而是增强他们的判断力并加速他们的输出。',
    ...
    strategicInsights: {
      ...
      question:
        '如果你的团队完全停止花时间在反应性任务上——回应竞争对手公告、生成例行报告、管理低价值沟通——并将释放的容量重新投入到 AI 增强的战略工作中，你会追求什么投资机会？',
      insight:
        '这个问题通常比"我们如何应对竞争对手的最新产品发布？"更接近真正的竞争优势来源。',
      keyPoint:
        '真正的竞争优势不在于做得更多，而在于将人力容量从反应性工作重新分配到战略思维——由 AI 增强。',
    },
    ...
    subtractPrinciple: {
      ...
      description:
        '当 AI 轨迹变得低效或不对齐时，解决方案不是应用更多计算或更用力推动。相反，应该重置到干净状态、切换模型或注入新的视角。',
      ...
      takeaways: [
        {
          ...
          title: 'AI 是放大器——方向最重要',
          description:
            'AI 不决定结果——你的战略才决定。正确的战略会被放大以产生超额回报。有缺陷的战略会被放大以加速失败。首先修复方向。',
        },
        {
          icon: '✖',
          title: '倍增器双向工作',
          description:
            '每个 AI 部署都是一个力量倍增器。大规模生产有缺陷的信息不是力量——而是大规模的弱点。战略清晰度乘以 AI 是唯一的持久优势之路。',
        },
        {
          icon: '📈',
          title: '复利器奖励早期采用者',
          description:
            'AI 优势通过数据、工作流和速度护城河复利累积。今天构建 AI 系统的团队创造的领先优势是后来者无法弥补的——无论预算多少。',
        },
        {
          icon: '◆',
          title: '拥有战略——使用 AI 加速',
          description:
            '用 AI 生成框架、检索知识、分析数据并扩展执行。但始终拥有战略逻辑、核心假设和质量标准。',
        },
        {
          icon: '−',
          title: '减法原理：重置，不要放大',
          description:
            '当 AI 偏离轨道时——重置到干净状态、切换模型、注入新视角。在有缺陷的轨迹上应用更多计算是在错误方向上的蛮力。',
        },
      ],
    },
    ...
    aiJourney: {
      ...
      steps: [
        { step: 1, title: '放大', description: '正确的战略' },
        { step: 2, title: '倍增', description: '有效的执行' },
        { step: 3, title: '复利', description: '竞争优势' },
      ],
      cta: '立即开始你的转变',
...
export type Content = typeof i18n.en;
